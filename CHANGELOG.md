...
3. Turtles can now chunk load without a peripheral, this is configurable and OFF by default. Turtles will also automatically turn on if they are self-chunk loaded.
4. Added some new config features.
# Internal Changes
