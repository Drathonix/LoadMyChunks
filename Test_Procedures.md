...
| Version \| Procedure | Boots | Placed Chunk Loader | Removed Chunk Loader | Placed & Extended Chunk Loader | Removed Extended Chunk Loader | Test Entity Ticking | Chunk Loader Item Consumption | Test forceload command | CCT: Repeat tasks 2,3 & 7 |
|----------------------|-------|---------------------|----------------------|--------------------------------|-------------------------------|---------------------|-------------------------------|------------------------|---------------------------|
| 1.16.5-Forge         | 0     |                     |                      |                                |                               |                     |                               | 3                      |                           |
| 1.16.5-Fabric        | 1     | 1                   | 1                    | 1                              | 1                             | 1                   | I will remove this column     | I will remove this     | 2                         |
| 1.18.2-Forge         | 1     | 1                   | 1                    | 1                              | 1                             | 1                   | in a future commit            | column in a future     |                           |
| 1.18.2-Fabric        | 1     | 1                   | 1                    | 1                              | 1                             | 1                   |                               | commit                 | 2                         |
| 1.19.2-Forge         | 1     |                     |                      |                                |                               |                     |                               | 3                      |                           |
| 1.19.2-Fabric        | 1     |                     |                      |                                |                               |                     |                               | 3                      | 2                         |
| 1.19.4-Forge         | 1     |                     |                      |                                |                               |                     |                               | 3                      |                           |
| 1.19.4-Fabric        | 1     |                     |                      |                                |                               |                     |                               | 3                      |                           |
