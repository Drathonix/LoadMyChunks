...
public class LoadMyChunksClient {
    ...
    public static void init(){
        ...
        ItemPropertiesRegistry.register(LoadMyChunks.itemTickometer.get(), new ResourceLocation("lag"), (ItemPropertyFunction)(itemStack, clientLevel, livingEntity) -> {
        ...
        ItemPropertiesRegistry.register(LoadMyChunks.itemChunkometer.get(), new ResourceLocation("lag"), (ItemPropertyFunction)(itemStack, clientLevel, livingEntity) -> {
            NetworkManager.sendToServer(LoadMyChunks.LAG_READING_PACKET_ID,new FriendlyByteBuf(Unpooled.buffer()));
            return LoadMyChunksClient.lagLevel;
        });
